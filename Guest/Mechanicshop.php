...
$SelQry="select * from tbl_mechanicshop  where mechanicshop_email='".$mechemail."'";
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="200" border="1" align="center">
    ...
    <tr>
      ...
      <input type="text" name="txt_address" id="txt_address" placeholder="Enter Your Address" required </td>
    </tr>
    <tr>
      <td>Logo</td>
